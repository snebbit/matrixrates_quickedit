    ...
    <head>
        ...
        <style>
            *{ font-family: arial,tahoma,sans-serif; color: #222; }
            ...
            #delivery-table tr:first-child{ background: #ddd; }
            #delivery-table tr:not(:first-child):hover{ background: #f3f3f3; }
            #delivery-table tr td:last-child{ width: 33%; text-align: center; }
            #delivery-table td, #delivery-table th{ padding: 8px 12px; }
